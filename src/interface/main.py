...
from my_app.adapters.api.middleware.error_handler import register_exception_handlers
from my_app.adapters.api.middleware.rate_limiter import limiter, rate_limit_exceeded_handler
from my_app.adapters.api.middleware.request_id import RequestIDMiddleware
from my_app.adapters.api.middleware.security_headers import SecurityHeadersMiddleware
from my_app.adapters.api.routes import auth, health, items
from my_app.adapters.api.versioning import APIVersion, VersionConfig, VersionedRouter
from my_app.core.config import get_settings
from my_app.core.container import Container, lifecycle
from my_app.infrastructure.database.session import init_database, close_database
from my_app.infrastructure.logging import configure_logging, get_logger
from my_app.infrastructure.observability.middleware import TracingMiddleware
from my_app.infrastructure.observability.telemetry import init_telemetry
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    try:
        from my_app.infrastructure.database.migrations import ensure_database_ready
