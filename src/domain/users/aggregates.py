...
from my_app.core.base.aggregate_root import AggregateRoot
from my_app.domain.users.value_objects import Email, PasswordHash, UserId
from my_app.domain.users.events import UserRegisteredEvent, UserDeactivatedEvent, UserEmailChangedEvent
